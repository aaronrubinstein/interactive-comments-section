...
<div class="score-control">
    <button class="increment-score" on:click={upVote} type="button" aria-label="upvote comment">
    ...
    <button class="decrement-score" on:click={downVote} type="button" aria-label="downvote comment">
